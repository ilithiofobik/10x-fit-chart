...
3.  **Wybór metody**:
    - _Opcja A_: Użytkownik klika "Kopiuj ostatni" -> System pobiera szablon z `/api/workouts/latest` -> Wypełnia formularz.
    - _Opcja B_: Użytkownik ręcznie wybiera datę i dodaje pierwsze ćwiczenie przez `ExerciseCombobox`.
